...
export const testimonials = [
  {
    ...
    name: "Sama Santai",
    review:
      "Bergabung di Voisa itu kayak buka pintu dunia paralel. Orang-orangnya ramah, ilmunya deras kayak sungai Amazon, dan diskusinya? Seru banget, kayak nonton drama Korea tapi versi edukasi.",
  ...
  },
  {
    ...
    name: "David Ngodingz",
    review:
      "Voisa itu komunitas yang nggak cuma ngobrol, tapi ngajarin! Diskusinya kayak hackathon tanpa deadline. Pokoknya, otak ini nggak bakal nganggur.",
  ...
  },
  {
    ...
    name: "Emily Photoshop",
    review:
      "Kalau Voisa jadi aplikasi, rating-nya pasti 6/5 bintang. Di sini aku belajar banyak hal, dari desain sampai coding. Plus, ada memes lucu biar nggak tegang!",
  ...
  },
  {
    ...
    name: "Michael Debugger",
    review:
      "Voisa itu kayak shortcut ke sukses. Semua yang kita butuhkan ada: ilmu, teman diskusi, bahkan tips curang buat ngoding (eh, bercanda kok!).",
  ...
  },
  {
    ...
    name: "Sarah Kodein",
    review:
      "Kalau disuruh pilih komunitas favorit, Voisa itu jawabannya. Serasa ikut seminar gratis tiap hari! Ilmu dapat, teman baru juga banyak.",
